...
require (
	github.com/Albert-Zhan/httpc v0.0.0-20210108125506-5dfbbfb7936e
...
//replace github.com/gomodule/redigo v2.0.1+incompatible => github.com/gomodule/redigo/redis v0.0.0-20200429221454-e14091dffc1b
